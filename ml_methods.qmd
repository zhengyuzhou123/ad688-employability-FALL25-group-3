...
```{python}
# 10. Plot feature importance (top 20 coefficients)
...
fig = px.bar(
    ...
    y="feature",
    orientation="h",
    title="Top Positive and Negative Coefficients (Salary Regression)"
)

fig.update_layout(template="plotly_white")
fig.show()
# Save PNG
fig.write_image("figures/feature_importance.png", scale=2)
```

```{python}
# 11. Actual vs Predicted salary scatter plot
...
# Save PNG
fig2.write_image("figures/actual_vs_predicted.png", scale=2)
```